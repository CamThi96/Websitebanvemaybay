...
<span style="display:block; padding-bottom:10px; margin-top:5px; margin-left:10px; font-weight:bold; color:red; font-size:28px">Giá đã bao gồm thuế và phí</span>
<?php
    ...
    font-weight:bold;"><?=$this->uri->segment(7)?></span>
		...
		?>
        	<div class="tvo_schedule">
            	<div class="content">
                    ...
                    <span class="chosen">
                    	<a href="<?=base_url()?><?=$this->uri->uri_string()?>/xac-nhan-don-hang/<?=$val['ma_chuyen_bay']?>" title="Tiếp theo -> xác nhận đơn hàng"><input type="radio" name="chosen" /><span>Chọn</span></a>
                    </span>
                    <div class="clear"></div>
                </div>
