...
function browser_detection( $which_test, $test_excludes='', $external_ua_string='' ) 
{
	...
	*/
	if ( !$b_repeat ) {
		...
		*/
		$a_webkit_types = array( 'arora', 'bolt', 'chromium', 'chrome', 'crios', 'dooble', 'epiphany', 'gtklauncher', 'icab', 'konqueror', 'maxthon',  'midori', 'omniweb', 'qupzilla', 'rekonq', 'rocketmelt', 'safari', 'shiira', 'sputnik', 'steel', 'teashark', 'uzbl', 'applewebkit', 'webos', 'xxxterm', 'webkit' );
...
function get_mobile_data( $pv_browser_user_agent )
{
	...
	*/
	...
	// mobile/tablet. gt-p1000 is samsung galaxy tablet
