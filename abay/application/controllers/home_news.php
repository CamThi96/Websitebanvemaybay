<?php
	...
	class Home_news extends Home_Default{
		...
		function _Check_news(){
			if($this->uri->segment(2)==''){
				...
				$data['news']=$this->mdnews->GetNews($this->uri->segment(2), 'news');
				if($data['news']==false){
					$this->_View_All();
				}else{
		...
		function _View_All(){
			...
			parent::_Set_Default_Left($this->my_layout->input('front_end/content/all_news',$data));
		}
	}
?>