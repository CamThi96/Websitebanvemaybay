<?php
	...
	class Home_Firm extends Home_Default{
		function __Construct(){
			parent::__Construct();
			$this->load->model(array('mdsearch', 'mdairport', 'mdairlines', 'mdschedule'));
			parent::_Add_Title('Vé Máy Bay Theo Hãng');
		}
		...
		function index(){
			...
			$this->my_layout->set_data('content_for_website', $this->my_layout->input('front_end/content/home_firm',$data));
